...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the Assert.AreEqual() fails: Expected:<Bob>. Actual:<Sue>
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim got removed from the queue after the first use. timTurns equaled -6 at the end
    ...
    // Defect(s) Found: timTurns does not equal -3 at the end
