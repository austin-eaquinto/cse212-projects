public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Displays queued items as 400, 300, 200
        ...
        // Defect(s) Found: Raised an exception because the index was set to 1 instead of 0 in Dequeue method
    }
    ...
    private void Enqueue(int value) {
        // this inserts the next item at the front of the queue which does not work for a queue
    ...
    private int Dequeue() {
        ...
        // the index of 1 doesn't work because the list is empty
        // var value = _queue[1];
        // _queue.RemoveAt(1);
        var value = _queue[0];
        _queue.RemoveAt(0);
